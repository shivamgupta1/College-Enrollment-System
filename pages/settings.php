							...
							<div class="col-lg-6">
								<fieldset disabled>
									<div class="form-group">
										...
										<input class="form-control" type="text" name="rollno" placeholder="<?php echo "$row[rollno]"?>" disabled>
									</div>
								</fieldset>
								<fieldset>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
									    		<label class="radio-inline">
                                            							<input type="radio" name="sex" value="Male" <?php echo ("$row[sex]"=='Male')?'checked':'' ?>>Male
                                        						</label>
                                        						<label class="radio-inline">
                                            							<input type="radio" name="sex" value="Female" <?php echo ("$row[sex]"=='Female')?'checked':''?>>Female
                                        						</label>
										</div>
									</div>
								<fieldset>
