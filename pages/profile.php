			...
			<div class="col-md-7">
				<div class="panel panel-green">
					...
					<div class="panel-body">
						<form role="form" class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id="myForm">
							<fieldset>
			...
			<div class="col-md-4">
				<div class="panel panel-success">
					...
					<div class="panel-body">
						...
						<input type="button" class="btn btn-primary" value="Edit Profile" id="myButton" />
